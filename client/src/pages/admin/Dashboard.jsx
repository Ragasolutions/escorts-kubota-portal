  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-4 sm:py-6">
        ...
        {/* Header Banner */}
        <div className="bg-green-700 rounded-2xl p-5 sm:p-6 text-white mb-6 relative overflow-hidden">

          <div className="absolute top-0 right-0 w-40 sm:w-48 h-40 sm:h-48 bg-green-600 rounded-full -translate-y-1/2 translate-x-1/2 opacity-50" />

          <div className="absolute bottom-0 left-1/2 w-28 sm:w-32 h-28 sm:h-32 bg-green-800 rounded-full translate-y-1/2 opacity-30" />
          ...
          <div className="relative z-10 flex items-start sm:items-center justify-between gap-4">
            ...
            <div className="hidden md:flex w-16 h-16 bg-white bg-opacity-10 rounded-2xl items-center justify-center shrink-0">
          ...
          {statCards.map((card) => (
            ...
            >
              ...
              <div className="flex items-center justify-between mb-3">
                ...
                <ArrowRight
                  size={16}
                  className="text-gray-300 group-hover:text-green-700 transition"
                />
              </div>
                  ...
                  {stats.recentOrders.map(
                    (order) => (
                      ...
                      >
                        ...
                        <td className="px-5 py-3 font-black text-gray-800 whitespace-nowrap">
                        ...
                        <td className="px-5 py-3 font-bold text-green-700 whitespace-nowrap">
                        ...
                        <td className="px-5 py-3 whitespace-nowrap">
                          ...
                          <span
                            className={`text-xs px-2 py-1 rounded-full font-bold ${statusColors[order.status]}`}
                          >
